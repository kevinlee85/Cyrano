...
//        // Code for asking user what they want to here goes here. Can be text to
...
//    }
//
//    // Here I am assuming an array of users. I am assuming that we will have a
//    // user object eventually as well.
//    public void speakListofUsers(String[] users) {
//        if (users.length > 3) {
//            AudioMethods.textToSpeech(null, tooManyUsers);
//        }
//        for (int i = 0; i < users.length; i++) {
//            // Here we iterate though the list to speak about all the found
//            // users. If it is less than 3.
//
//            // speakAboutUser(users[i].firstName, users[i].lastName,
//            // users[i].email, users[i].phoneNumber);
//        }
//    }
//
//}
