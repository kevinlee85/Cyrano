...
public class TaskGetAllScripts extends AsyncTask<Void, Void, JSONArray> {
    private final static String TAG = "TaskGetAllScripts";
     ...
     */
    public TaskGetAllScripts(ActivityCyrano activity) {
    ...
    protected JSONArray doInBackground(Void... arg0) {
        ...
        String requestUrl = Constants.SERVER_ROOT 
                + Constants.SEPERATOR + Constants.SERVICE_ALL_SCRIPT
