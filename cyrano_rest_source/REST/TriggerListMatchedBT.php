	...
	*/
	 ...
	 public function get($token, $userId,$btlist)
	{
		...
		{	
            ...
            $commandQuery = "SELECT t.script_id as script_id,t.command_id as command_id FROM $dbname.triggers_alarms as t,$dbname.devices as d  WHERE d.device_mac_address in ($btlist) and d.device_id =t.device_id
