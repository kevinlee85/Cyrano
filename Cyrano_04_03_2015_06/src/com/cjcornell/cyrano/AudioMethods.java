...
public class AudioMethods {
   ...
   public static AudioManager myAudioManager,myam;
    /**
     * playSound
    ...
    public static void playInstructfions(Context context, final List<String> instructions,
