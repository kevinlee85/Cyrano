...
public class CommandGroupAdapter extends ArrayAdapter<ScriptItem> {
    private final Context context;
    private final List<ScriptItem> commandGroups;
    
    /** Constructor */
    public CommandGroupAdapter(Context context, final List<ScriptItem> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ScriptItem item = commandGroups.get(position);
